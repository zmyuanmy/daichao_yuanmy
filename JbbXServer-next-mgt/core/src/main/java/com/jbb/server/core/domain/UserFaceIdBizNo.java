...
public class UserFaceIdBizNo {
    ...
    public String toString() {
        return "userFaceId [userId=" + userId + ", randomNumber=" + randomNumber
            + ", bizNo=" + bizNo + ", tokenRandomNumber=" + tokenRandomNumber + ", tokenVideo=" + tokenVideo
            + ", randomData=" + randomData + ", validateVideoData=" + validateVideoData + ", verifyData=" + verifyData
            + "]";
    }
