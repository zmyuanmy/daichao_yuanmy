 ...
 */
public class QuickPayConfirmPayRspVo {
    ...
    public QuickPayConfirmPayRspVo() {
        super();
    }

    public QuickPayConfirmPayRspVo(String rt1_bizType, String rt2_retCode, String rt3_retMsg, String rt4_customerNumber,
    ...
    public String toString() {
        return "QuickPayConfirmPayRspVo{" + "rt1_bizType='" + rt1_bizType + '\'' + ", rt2_retCode='" + rt2_retCode
