...
public class Message {
    ...
    public String toString() {
        return "Message [messageId=" + messageId + ", fromUserId=" + fromUserId + ", toUserId=" + toUserId
            + ", appName=" + appName + ", creationDate=" + creationDate + ", sendDate=" + sendDate + ", subject="
            + subject + ", messageType=" + messageType + ", messageText=" + messageText + ", sms=" + sms + ", push="
            + push + ", parameters=" + parameters + ", read=" + read + ", hidden=" + hidden + "]";
    }
