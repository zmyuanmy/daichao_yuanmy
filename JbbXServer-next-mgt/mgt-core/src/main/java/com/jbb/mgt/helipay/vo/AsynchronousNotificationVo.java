 ...
 */
public class AsynchronousNotificationVo {
    ...
    public AsynchronousNotificationVo() {
        super();
    }
    ...
    public String toString() {
        return "AsynchronousNotificationVo{" + "rt1_bizType='" + rt1_bizType + '\'' + ", rt2_retCode='" + rt2_retCode
