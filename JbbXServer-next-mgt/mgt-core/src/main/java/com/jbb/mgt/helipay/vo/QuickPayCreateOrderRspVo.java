 ...
 * 
 * @author wyq
 * @date 2018/8/29 19:24
 */
public class QuickPayCreateOrderRspVo {
    ...
    public QuickPayCreateOrderRspVo() {
        super();
    }
    ...
    public String toString() {
        return "QuickPayCreateOrderRspVo{" + "rt1_bizType='" + rt1_bizType + '\'' + ", rt2_retCode='" + rt2_retCode
            + '\'' + ", rt3_retMsg='" + rt3_retMsg + '\'' + ", rt4_customerNumber='" + rt4_customerNumber + '\''
            + ", rt5_orderId='" + rt5_orderId + '\'' + ", sign='" + sign + '\'' + '}';
    }
}
