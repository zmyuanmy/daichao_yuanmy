...
public class TransferQueryRspVo {
    ...
    public String getSigned() {
        ...
        sb.append("&");
        sb.append(this.getRt7_orderStatus() == null ? "" : this.getRt7_orderStatus());
        sb.append("&");
        sb.append(this.getRt8_reason() == null ? "" : this.getRt8_reason());
        return sb.toString();
    }
    ...
    public String toString() {
        return "TransferQueryRspVo [rt1_bizType=" + rt1_bizType + ", rt2_retCode=" + rt2_retCode + ", rt3_retMsg="
