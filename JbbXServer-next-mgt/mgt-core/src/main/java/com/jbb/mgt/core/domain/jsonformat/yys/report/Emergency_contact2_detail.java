 ...
 */
package com.jbb.mgt.core.domain.jsonformat.yys.report;

/**
 * Auto-generated: 2018-08-27 14:41:12
 *
 * @author bejson.com (i@bejson.com)
 * @website http://www.bejson.com/java2pojo/
 */
public class Emergency_contact2_detail {

    private String call_count_holiday_3month;
    private int call_count_holiday_6month;
    private String contact_attribute;
    private int call_count_active_6month;
    private String call_time_3month;
    private String msg_count_3month;
    private int call_time_passive_6month;
    private String call_time_1month;
    private String call_count_active_3month;
    private int call_time_6month;
    private String contact_type;
    private String call_count_late_night_3month;
    private int call_count_late_night_6month;
    private int call_count_passive_6month;
    private int call_time_active_6month;
    private String call_time_work_time_6month;
    private int msg_count_6month;
    private int call_count_work_time_6month;
    ...
    private int call_count_offwork_time_6month;
    ...
    private int call_count_workday_6month;
    ...
    public void setCall_count_holiday_6month(int call_count_holiday_6month) {
        this.call_count_holiday_6month = call_count_holiday_6month;
    }

    public int getCall_count_holiday_6month() {
    ...
    public void setCall_count_active_6month(int call_count_active_6month) {
        this.call_count_active_6month = call_count_active_6month;
    }

    public int getCall_count_active_6month() {
    ...
    public void setCall_time_passive_6month(int call_time_passive_6month) {
        this.call_time_passive_6month = call_time_passive_6month;
    }

    public int getCall_time_passive_6month() {
    ...
    public void setCall_time_6month(int call_time_6month) {
        this.call_time_6month = call_time_6month;
    }

    public int getCall_time_6month() {
    ...
    public void setCall_count_late_night_6month(int call_count_late_night_6month) {
        this.call_count_late_night_6month = call_count_late_night_6month;
    }

    public int getCall_count_late_night_6month() {
        return call_count_late_night_6month;
    }

    public void setCall_count_passive_6month(int call_count_passive_6month) {
        this.call_count_passive_6month = call_count_passive_6month;
    }

    public int getCall_count_passive_6month() {
        return call_count_passive_6month;
    }

    public void setCall_time_active_6month(int call_time_active_6month) {
        this.call_time_active_6month = call_time_active_6month;
    }

    public int getCall_time_active_6month() {
    ...
    public void setMsg_count_6month(int msg_count_6month) {
        this.msg_count_6month = msg_count_6month;
    }

    public int getMsg_count_6month() {
        return msg_count_6month;
    }

    public void setCall_count_work_time_6month(int call_count_work_time_6month) {
        this.call_count_work_time_6month = call_count_work_time_6month;
    }

    public int getCall_count_work_time_6month() {
    ...
    public void setCall_count_6month(int call_count_6month) {
        this.call_count_6month = call_count_6month;
    }

    public int getCall_count_6month() {
    ...
    public void setCall_count_offwork_time_6month(int call_count_offwork_time_6month) {
        this.call_count_offwork_time_6month = call_count_offwork_time_6month;
    }

    public int getCall_count_offwork_time_6month() {
    ...
    public void setCall_count_workday_6month(int call_count_workday_6month) {
        this.call_count_workday_6month = call_count_workday_6month;
    }

    public int getCall_count_workday_6month() {
