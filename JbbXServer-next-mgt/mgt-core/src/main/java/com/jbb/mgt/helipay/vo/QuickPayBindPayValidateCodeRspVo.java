 ...
 */
public class QuickPayBindPayValidateCodeRspVo {
    ...
    public QuickPayBindPayValidateCodeRspVo() {
        super();
    }

    public QuickPayBindPayValidateCodeRspVo(String rt1_bizType, String rt2_retCode, String rt3_retMsg,
    ...
    public String toString() {
        return "QuickPayBindPayValidateCodeRspVo{" + "rt1_bizType='" + rt1_bizType + '\'' + ", rt2_retCode='"
            + rt2_retCode + '\'' + ", rt3_retMsg='" + rt3_retMsg + '\'' + ", rt4_customerNumber='" + rt4_customerNumber
