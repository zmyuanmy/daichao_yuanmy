...
public class Endowment_insurance {
    ...
    private long monthly_company_income;
    private String type;
    private long monthly_personal_income;
    ...
    public long getMonthly_company_income() {
        return monthly_company_income;
    }

    public void setMonthly_company_income(long monthly_company_income) {
    ...
    public long getMonthly_personal_income() {
        return monthly_personal_income;
    }

    public void setMonthly_personal_income(long monthly_personal_income) {
