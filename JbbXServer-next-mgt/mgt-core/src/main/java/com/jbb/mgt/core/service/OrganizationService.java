...
public interface OrganizationService {
    ...
    // 通过ID获取组织信息
    Organization getOrganizationById(int orgId, boolean detail);

    // 删除组织信息
    boolean deleteOrganization(int orgId);

    List<Organization> getOrganizations(boolean detail, boolean getStatistic, boolean getAdStatistic,
