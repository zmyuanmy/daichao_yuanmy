 ...
 */
public class Home {
	static final String HOME_DIR_PROPERTY = "YUANMY_HOME";
	static final String ENCRYPTION_PASSWORD_PROPERTY = "YUANMY_ENCRYPTION_PASSWORD";
	static final String ENCRYPTION_ALGORITHM = "PBEWithSHA1AndDESede";

	private static final String KEK_PROPERTY = "YUANMY_KEK";
