...
public class User {
    ...
    private List<UserProperty> userPropertys;
    ...
    public List<UserProperty> getUserPropertys() {
        return userPropertys;
    }

    public void setUserPropertys(List<UserProperty> userPropertys) {
    ...
    public String toString() {
        return "User{" + "userId=" + userId + ", jbbUserId=" + jbbUserId + ", userName='" + userName + '\''
            + ", phoneNumber='" + phoneNumber + '\'' + ", idCard='" + idCard + '\'' + ", ipAddress='" + ipAddress + '\''
            + ", ipArea='" + ipArea + '\'' + ", zhimaScore=" + zhimaScore + ", qq='" + qq + '\'' + ", wechat='" + wechat
            + '\'' + ", channelCode='" + channelCode + '\'' + ", realnameVerified=" + realnameVerified
            + ", mobileVerified=" + mobileVerified + ", zhimaVerified=" + zhimaVerified + ", jingdongVerified="
            + jingdongVerified + ", siVerified=" + siVerified + ", gjjVerified=" + gjjVerified + ", chsiVerified="
            + chsiVerified + ", taobaoVerified=" + taobaoVerified + ", videoVerified=" + videoVerified
            + ", hasContacts=" + hasContacts + ", ocrIdcardVerified=" + ocrIdcardVerified + ", idcardVerified="
            + idcardVerified + ", creationDate=" + creationDate + ", idcardRear='" + idcardRear + '\''
            + ", idcardBack='" + idcardBack + '\'' + ", idcardInfo='" + idcardInfo + '\'' + ", contract1Relation='"
            + contract1Relation + '\'' + ", contract1Username='" + contract1Username + '\'' + ", contract1Phonenumber='"
            + contract1Phonenumber + '\'' + ", contract2Relation='" + contract2Relation + '\'' + ", contract2Username='"
            + contract2Username + '\'' + ", contract2Phonenumber='" + contract2Phonenumber + '\''
            + ", vidoeScreenShot='" + vidoeScreenShot + '\'' + ", platform='" + platform + '\''
            + ", mobileManufacture='" + mobileManufacture + '\'' + ", idcardAddress='" + idcardAddress + '\''
            + ", race='" + race + '\'' + ", sex='" + sex + '\'' + ", age=" + age + ", census='" + census + '\''
            + ", key=" + key + ", channels=" + channels + ", applyId=" + applyId + ", initMarks='" + initMarks + '\''
            + ", applyOrgIds='" + applyOrgIds + '\'' + ", applyOrgNames='" + applyOrgNames + '\'' + ", isHidden="
            + isHidden + ", userType=" + userType + ", zhimaMin=" + zhimaMin + ", zhimaMax=" + zhimaMax + ", password='"
            + password + '\'' + ", maritalStatus=" + maritalStatus + ", education='" + education + '\''
            + ", contract1XjlRelation='" + contract1XjlRelation + '\'' + ", contract1XjlUsername='"
            + contract1XjlUsername + '\'' + ", contract1XjlPhonenumber='" + contract1XjlPhonenumber + '\''
            + ", contract2XjlRelation='" + contract2XjlRelation + '\'' + ", contract2XjlUsername='"
            + contract2XjlUsername + '\'' + ", contract2XjlPhonenumber='" + contract2XjlPhonenumber + '\''
            + ", xjlBasicInfoVerified=" + xjlBasicInfoVerified + ", liveAddress=" + liveAddress + ", jobInfo=" + jobInfo
            + ", cardStatus=" + cardStatus + ", avatarPic='" + avatarPic + '\'' + ", occupation='" + occupation + '\''
