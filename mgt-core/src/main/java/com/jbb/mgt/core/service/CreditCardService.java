...
public interface CreditCardService {
    ...
    // 信用卡分类
    List<CreditCard> getCreditCardByCategoryId(String cityName, Integer categoryId);

    // 全部卡片信息
    List<CreditCard> getCreditCardByCity(String cityName, Integer categoryId, Boolean isDeleted, Timestamp startDate,
        Timestamp endDate);

    // 单个卡片信息查询
    CreditCard getCreditCardById(Integer creditId);
